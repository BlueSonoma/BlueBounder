...
from skimage.color import gray2rgb, rgb2hsv, hsv2rgb, label2rgb
...
def segment_and_overlay_chemistry(band_contrast: np.array, chem_mask: np.array, opacity: float = 1,
